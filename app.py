...
def main():
    st.set_page_config(
        page_title="Final Project by Data Sapiens",
        page_icon="💼",
        layout="wide"
    )
    ...
    if choice == 'Home':
        ...
        st.markdown(
            ...
            <h1 style='text-align: center; color: #4B8BBE;'>
                Welcome to Prediction Employee Income Classification Final Project by Data Sapiens
            </h1>
            """,
